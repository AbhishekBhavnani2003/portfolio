...
import Rimg from '../images/RTS.png'
...
const projectsData = [
  {
    id: 1,
    imgUrl: Rimg,
    title: "Rohan's Tax Services",
    description: "Rohan Tax Services is a professional portfolio website built using the MERN stack, developed for founder Nilesh H. Gajjar. It features the firm’s services, blogs, and financial tools, along with a custom-built advanced dashboard I developed for efficient content management and site updates. ",
    link: "https://www.nileshhgajjar.in/"
  },
  {
    id: 2,
    imgUrl: Cimg,
  ...
  },
  {
    ...
    link: "https://kalamindia.netlify.app/"
  },
  {
    id: 4,
    imgUrl: Fimg,
  ...
  },
  {
    ...
    link: 'https://ethernotes.netlify.app/'
  },
  {
    id: 7,
    imgUrl: Qimg,
  ...
  },
  {
    ...
    link: "https://kshaminnovation.netlify.app/"
  },
  {
    id: 9,
    imgUrl: Timg,
        ...
        <section className="flex flex-col justify-center max-w-6xl min-h-screen px-4 py-10 mx-auto sm:px-6">
          <div className="flex flex-wrap items-center justify-between mb-8">
            <p className="mr-10 text-4xl font-bold leading-none text-gray-100 md:text-5xl" style={{ fontSize: '15px', cursor: 'default', padding: '5px', lineHeight: '1.5' }}>
              This page showcases some of the projects I've worked on early in my journey.
            </p>
          </div>
